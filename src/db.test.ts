...
describe('persistence',()=>{
  ...
  it('returns persisted data when present',async()=>{const data=seedData();mocks.get.mockResolvedValue(data);expect(await loadData()).toBe(data);expect(mocks.get).toHaveBeenCalledWith('state','app')});
